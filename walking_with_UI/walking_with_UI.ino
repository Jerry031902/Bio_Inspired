...
// ---------------- Counts ----------------
const long REAR_LEFT_COUNTS_PER_CYCLE   = 675;
const long REAR_RIGHT_COUNTS_PER_CYCLE  = 675;
const long FRONT_LEFT_COUNTS_PER_CYCLE  = 514;
const long FRONT_RIGHT_COUNTS_PER_CYCLE = 538;
