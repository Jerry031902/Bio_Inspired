...
void motorForward(int inaPin, int inbPin, int pwmPin, uint8_t speed) {
...
void setup() {
    ...
    Serial.println("- If motor stalls during ramp-down, increase minimum speed (60) in rotateOneRevolution()");
